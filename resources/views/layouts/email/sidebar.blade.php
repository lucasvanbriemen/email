<div class='sidebar'>
    ...
    @foreach ($folders as $folder)
        <div class='folder @if ($folder->path == $selectedFolder->path) selected @endif' data-url='/{{ $selectedProfile->id }}/folder/{{ $folder->path }}/listing' data-path='/{{ $selectedProfile->id }}/folder/{{ $folder->path }}'>
