...
Route::get('{credential_id}/folder/{folder}/mail/{uuid}', [MailboxController::class, 'show'])->middleware(['auth', 'verified', 'update_last_activity'])->name('mailbox.folder.mail');

Route::get('{credential_id}/folder/{folder}', [MailboxController::class, 'index'])->middleware(['auth', 'verified'])->name('mailbox.folder');

Route::post('/test', [OutboundMailController::class, 'sendEmail'])->middleware(['auth', 'verified'])->name('mailbox.folder');
...
Route::post('{credential_id}/folder/{folder}/mail/{uuid}/read_thread', [MailboxController::class, 'readThread'])->middleware(['auth', 'verified', 'update_last_activity'])->name('mailbox.folder.mail.read_thread');
...
Route::post('{credential_id}/folder/{folder}/mail/{uuid}/star_thread', [MailboxController::class, 'starThread'])->middleware(['auth', 'verified', 'update_last_activity'])->name('mailbox.folder.mail.star_thread');
